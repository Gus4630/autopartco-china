              ...
              <div class="space-y-4">
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <a :href="`tel:${config.public.companyPhone}`" class="text-primary-600 hover:underline">
                ...
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <a :href="`tel:${config.public.companyLandline}`" class="text-primary-600 hover:underline">
                ...
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <a :href="`mailto:${config.public.companyEmail}`" class="text-primary-600 hover:underline">
